...
Route::get('/{id}blog','App\Http\Controllers\HomeController@oneBlog');
Route::get('/{id}category', 'App\Http\Controllers\Admin\CategoryController@openCategory');
...
Route::prefix('admin')->middleware('auth')->group(function(){
    ...
    Route::get('/blog', 'App\Http\Controllers\Admin\DashboardController@create');
});

Route::get('/type', 'App\Http\Controllers\Admin\CategoryController@type');
